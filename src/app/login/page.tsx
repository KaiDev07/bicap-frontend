            ...
            <div className="session">
                ...
                <form action="" className="login-form" autoComplete="off">
                    <h4 className="login-h4">
                        <span>NOMAD TRAVEL</span>
                    </h4>
                    <p>
                        С возвращением! Войдите в аккаунт, чтобы подобрать тур.
                    </p>
                    ...
                    <button
                        disabled={user.isLoading || isLoadingLogin}
                        onClick={() => login(email, password)}
                        className="login-button"
                    >
                        Log in
                    </button>
                    <Link href="/signup">Нет аккаунта? Создайте здесь</Link>
                </form>
            </div>
        </main>
    );
